...
# sqlite is an data base engine ,it does not have a separate server process
#read and write directly to ordinary disk files 
# make database and users (if not exists already) table at programme start up
# we use sqlite to store requried infromation like trip access,driver proflie ,others 
with sqlite3.connect('Users.db') as db:
    c = db.cursor()# customer data store 
...
#main Class
class user:
    def __init__(self,master):# return a object with  given name ,an object of class is constructed
    	# Window 
        self.master = master
        # use string variables for user and password seting 
        self.username = StringVar()
        self.password = StringVar()
        self.n_username = StringVar()
        self.n_password = StringVar()
        #Create Widgets
        # it helps a component of an interface that enables a user to perform a function or access a service 
        self.widgets()

    #Login Function
    def login(self):
    	#Establish Connection between user and ageant data to be store 
        with sqlite3.connect('Users.db') as db:
            c = db.cursor()

        #Find user If there is any take proper action( if  details  are forgotten )
        find_user = ('SELECT * FROM user WHERE username = ? and password = ?')
        c.execute(find_user,[(self.username.get()),(self.password.get())])
        result = c.fetchall()
        if result:
            self.logf.pack_forget()# linklist concept 
    ...
    def new_user(self):
    	#Establishing  Connection to store data 
        with sqlite3.connect('Users.db') as db:
            c = db.cursor()
        ...
        #Frame Packing Methords in tkinker method ,declares the position of  user and can driver data  widgets in realtion  to each other 
    def log(self):
        self.username.set('')
        self.password.set('')
    ...
    def widgets(self):
     ...
     # site configartion for cab booking system
class travel:
    ...
    #==========================================Define Functiom==================================================
    # logouting are exiting cab agent 
        def iExit():
            iExit= ms.reddy("Prompt!","Do you want to exit?")
            if iExit > 0:
                root.destroy()
                return
        ...
        # recept details adding fuctions
        def Receiptt():
        ...
        # cab configaration selecting  functions adding with locations 
        def selectCar():
            global Item5
            if carType.get() == 1:
                self.txtFordGalaxy.configure(state = DISABLED)
                ...
                # amount calucaltion funcation with        
        def Total_Paid():
   ...
   #================================================mainframe========================================================================
    ...
    #===============================================Cab  avaliable in website funcation Information==============================================================
    ...
    #===============================================Cab extra amount cal;culation funcation Information==============================================================
    ...
    #==========================================================Cabselect funcation for coustamers =======================================================================
